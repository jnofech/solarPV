function [roofs_modified,roof_isbad_modified,blob_info] = blob_classify(roofs,roof_isbad,Z,dZdX,dZdY,pix2m,roof_mindiameter,loop)
...
%         imagesc(roofs); axis image; colorbar; title('BAD roofs');
    ...
    isroof_irr = regional_minmax_split(Z,dZdX,dZdY,roofs_irr,roof_isbad,pix2m);
